...
$_['text_no_results']    = 'Você não possui endereços vinculados a sua conta.';
$_['text_default']       = 'Principal';
$_['text_confirm']       = 'Você tem certeza?';
$_['text_recipient_other'] = 'Entregar para outra pessoa';
...
// Error
$_['error_token']        = 'Atenção: token de endereço inválido!';
$_['error_subscription'] = 'Atenção: o endereço ainda está em uso por %s assinatura(s) ativa(s)!';
